...
## Decision: Beginner UX Feedback — 8-Workout E2E Journey

**Date:** 2026-04-14  
**Author:** Switch (Tester)  
**Context:** Realistic beginner simulation to evaluate first-time user experience
...
## Decision: Feature Requests — Supersets & Drag-Drop Reordering

**Date:** 2026-04-13  
**Author:** Copilot (User Feedback)  
**Status:** Backlog for v1.1+

### 2026-04-13T21:04:14Z: User feedback — Future features

**By:** Copilot (via Copilot)

**What:**
1. **Superseries en programas:** Los programas deberían poder tener superseries (supersets). El usuario debería poder agrupar/desagrupar manualmente ejercicios en superseries dentro de su rutina.
2. **Reordenar ejercicios arrastrando:** El usuario debería poder reordenar los ejercicios en su sesión arrastrándolos (drag & drop) para hacerlos en el orden que mejor le convenga en ese momento.

**Why:** User feedback — features deseadas para mejorar la experiencia de entrenamiento. Capturadas para v1.1+ backlog.
